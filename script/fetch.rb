...
data = Kitties.v0.get_cattributes   ## same as get( '/cattributes' )
save( "v0a.cattributes", data )
data = Kitties.v0.get_kitty( 1 )    ## same as get( '/kitties/1' )
save( "v0a.kitty-1", data )
data = Kitties.v0.get_kitty( 2 )    ## same as get( '/kitties/2' )
save( "v0a.kitty-2", data )

##
##  or

## note: requires CryptoKitties API Token; set in ENV via KITTIES_TOKEN
data = Kitties.v1.get_cattributes  ## same as get( '/cattributes' )
save( "v1a.cattributes", data )
data = Kitties.v1.get_kitty( 1 )   ## same as get( '/kitties/1' )
save( "v1a.kitty-1", data )
